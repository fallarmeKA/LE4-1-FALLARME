...
namespace BlogTestUI
{
    internal class Program
    {
        ...
        private static void ListPosts(SqlData db)
        {
            ...
            {
                Console.WriteLine($"{post.Id}. Title: {post.Title} by {post.UserName} [{post.DataCreated.ToString("yyyy-MM-dd")}]");
        ...
        private static void ShowPostDetails(SqlData db)
        {
            ...
            Console.WriteLine(post.DataCreated.ToString("MMM d yyyy"));
        }
